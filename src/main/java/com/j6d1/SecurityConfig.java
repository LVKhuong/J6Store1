...
import com.j6d1.service.impl.UserServiceImpl;
...
//			.and()
//			.withUser("user3").password(this.getPasswordEncode().encode("123")).roles("GUEST");
	...
	protected void configure(HttpSecurity http) throws Exception {
		...
		.antMatchers("/rest/authorities", "/rest/authorities/**","/rest/authoritiesAdmin").authenticated()
		.antMatchers("/assets/admin", "/assets/admin/**").authenticated()
