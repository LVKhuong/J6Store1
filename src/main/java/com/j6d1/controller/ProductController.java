...
//	}
	...
	public String paginate(Model model,
						   @PathParam("p") Optional<Integer> p,
						   @PathVariable("cID") Optional<Integer> cID,
						   @PathParam("search") Optional<String> search)
	{
		//
		Pageable pageable = PageRequest.of(p.orElse(0), 6, Sort.by(Sort.Direction.DESC, "price"));
